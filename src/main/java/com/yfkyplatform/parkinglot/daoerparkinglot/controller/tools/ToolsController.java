package com.yfkyplatform.parkinglot.daoerparkinglot.controller.tools;
...
import com.yfkyplatform.parkinglot.daoerparkinglot.controller.tools.request.ViewHttpApiProxy;
...
public class ToolsController {
    ...
    public ToolsController(RestTemplate restTemplate, ObjectMapper mapper, ParkingLotManagerFactory factory){
        ...
        this.mapper = mapper;
        //this.api= factory.manager("Daoer").parkingLot("DaoerTest");
    }
