package com.yfkyplatform.parkinglot.carpark.daoer.client;

import com.yfkyplatform.parkinglot.carpark.daoer.client.domin.DaoerWebClient;
import com.yfkyplatform.parkinglot.carpark.daoer.client.domin.api.*;
import com.yfkyplatform.parkinglot.carpark.daoer.client.domin.model.DaoerBase;
import com.yfkyplatform.parkinglot.carpark.daoer.client.domin.model.carpark.*;
import com.yfkyplatform.parkinglot.carpark.daoer.client.domin.model.coupon.CouponQuery;
import com.yfkyplatform.parkinglot.carpark.daoer.client.domin.model.coupon.CouponUse;
import com.yfkyplatform.parkinglot.carpark.daoer.client.domin.model.guest.GuestMessage;
import com.yfkyplatform.parkinglot.carpark.daoer.client.domin.model.guest.GuestWithId;
import com.yfkyplatform.parkinglot.carpark.daoer.client.domin.model.monthlycar.RenewalMonthlyCar;
import com.yfkyplatform.parkinglot.carpark.daoer.client.domin.resp.carport.*;
...
public class DaoerClient extends DaoerWebClient implements IDaoerCarPort, IDaoerMonthlyCar, IDaoerGuest, IDaoerCoupon, IDaoerTool {
     ...
     */
    @Override
    public Mono<DaoerBaseResp<GuestResult>> createGuest(String guestName,String carNo,String visitTime,String mobile,String description){
     ...
     */
    @Override
    public Mono<DaoerBaseResp> changeGuestMessage(String objectId,String guestName,String visitTime,String mobile,String description){
