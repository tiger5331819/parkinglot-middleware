package com.yfkyplatform.parkinglot.carpark.daoer.controller.monthly;

import com.yfkyplatform.parkinglot.carpark.daoer.client.domin.api.IDaoerMonthlyCar;
...
import com.yfkyplatform.parkinglot.carpark.daoer.controller.monthly.request.RenewalMonthlyCarRequest;
...
public class MonthlyCarController {
    ...
    public MonthlyCarController(ParkingLotManager manager){
        api=manager.parkingLot("DaoerTest").client();
    }
