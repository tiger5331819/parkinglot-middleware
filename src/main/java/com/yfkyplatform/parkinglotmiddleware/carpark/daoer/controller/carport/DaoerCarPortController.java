...
public class DaoerCarPortController {
    ...
    private IDaoerCarPort api(Long parkingLotId) {
    ...
    @GetMapping
    public DaoerBaseResp<List<CarportResult>> getCarport(@PathVariable Long parkingLotId) {
        return api(parkingLotId).getCarPortInfo().block();
    }

    @ApiOperation(value = "获取临时车缴纳金额")
    @GetMapping("/fee")
    public DaoerBaseResp<CarFeeResult> getCarFee(@PathVariable Long parkingLotId, String carNo) {
        return api(parkingLotId).getCarFeeInfo(carNo).block();
    }

    @ApiOperation(value = "根据通道号获取缴纳金额")
    @GetMapping("/fee/channel")
    public DaoerBaseResp<CarFeeResult> getChannelCarFee(@PathVariable Long parkingLotId, String channelId, String carNo, String openId) {
        return api(parkingLotId).getChannelCarFee(channelId, carNo, openId).block();
    }

    @ApiOperation(value = "临停缴费支付")
    @PostMapping("/fee")
    public DaoerBaseResp payCarFee(@PathVariable Long parkingLotId, @RequestBody CarFeePayRequest request) {
    ...
    public DaoerBaseResp<BlankCarInResult> blankCarIn(@PathVariable Long parkingLotId, @RequestBody BlankCarRequest request) {
    ...
    public DaoerBaseResp<BlankCarOutResult> blankCarOut(@PathVariable Long parkingLotId, @RequestBody BlankCarRequest request) {
    ...
    @GetMapping("/in")
    public DaoerBaseResp<CarInOrOutResult<CarInData>> getCarIn(@PathVariable Long parkingLotId,
    ...
    @GetMapping("/out")
    public DaoerBaseResp<CarInOrOutResult<CarOutData>> getCarOut(@PathVariable Long parkingLotId, String carNo, String startTime, String endTime, int pageNum, int pageSize) {
        return api(parkingLotId).getCarOutInfo(carNo, startTime, endTime, pageNum, pageSize).block();
    }

    @ApiOperation(value = "获取通道列表")
    @GetMapping("/channels")
    public DaoerBaseResp<List<ChannelResult>> getChannels(@PathVariable Long parkingLotId) {
        return api(parkingLotId).getChannelsInfo().block();
    }

    @ApiOperation(value = "获取通道状态")
    @GetMapping("/channels/State")
    public DaoerBaseResp<List<ChannelStateResult>> getChannelStates(@PathVariable Long parkingLotId) {
        return api(parkingLotId).getChannelStates().block();
    }

    @ApiOperation(value = "道闸开关操作")
    @PostMapping("/channels")
    public DaoerBaseResp<List<ChannelStatusResult>> controlChannel(@PathVariable Long parkingLotId, @RequestBody ControlChannelRequest request) {
