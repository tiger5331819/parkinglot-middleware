...
public class DaoerMonthlyCarController {
    ...
    public DaoerBaseResp<MonthlyCarResult> getCarInfo(@PathVariable String parkingLotId, @Parameter(name =  "车牌号") @PathVariable String carNo) {
        return api(parkingLotId).getMonthlyCarInfo(carNo).block();
    }

    @Operation(summary =  "获取月租车历史缴费信息")
    @GetMapping(value= "/{carNo}/history")
    public DaoerBaseResp<List<MonthlyCarHistoryResult>> getCarHistory(@PathVariable String parkingLotId, @Parameter(name =  "车牌号") @PathVariable String carNo) {
        return api(parkingLotId).getMonthlyCarHistory(carNo).block();
    }

    @Operation(summary =  "创建月租车")
    @PostMapping(value= "/{carNo}")
    public DaoerBaseResp<MonthlyCarResult> createCar(@PathVariable String parkingLotId, @Parameter(name =  "车牌号码") @PathVariable String carNo, @RequestBody CreateMonthlyCarRequest request) {
    ...
    public DaoerBaseResp<MonthlyCarResult> renewalCar(@PathVariable String parkingLotId, @Parameter(name =  "车牌号码") @PathVariable String carNo, @RequestBody RenewalMonthlyCarRequest request) {
    ...
    public DaoerBaseResp<MonthlyCarResult> removeCar(@PathVariable String parkingLotId, @Parameter(name =  "车牌号码") @PathVariable String carNo) {
        return api(parkingLotId).removeMonthlyCar(carNo).block();
    }

    @Operation(summary =  "查询特殊车辆")
    @GetMapping(value= "/special")
    public DaoerBaseResp<PageModel<SpecialMonthlyCarResult>> getSpecialCar(@PathVariable String parkingLotId, @Parameter(name =  "车牌号码") Integer pageIndex, Integer pageSize) {
    ...
    public DaoerBaseResp saveSpecialCar(@PathVariable String parkingLotId, @Parameter(name =  "车牌号码") @PathVariable String carNo, @RequestBody SpecialCarRequest request) {
