...
public class ManagerConfigurationController {
    ...
    public Boolean addDaoerCongfiguration(String id, String appName, String parkId, String baseUrl){
        return managerConfigurationService.addDaoerCongfiguration(id, appName, parkId, baseUrl);
    }

    @ApiOperation(value = "修改道尔停车场配置文件")
    @PutMapping("/Daoer/Configuration/{id}")
    public Boolean updateDaoerCongfiguration(@PathVariable String id, String appName, String parkId, String baseUrl){
        return managerConfigurationService.addDaoerCongfiguration(id, appName, parkId, baseUrl);
    }
}
