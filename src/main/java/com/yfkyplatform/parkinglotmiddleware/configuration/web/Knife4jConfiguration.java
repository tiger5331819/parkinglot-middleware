...
public class Knife4jConfiguration {
    ...
    public Docket daoerProxyAPI() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                // 需要扫描的Controller包路径
                .apis(RequestHandlerSelectors.basePackage("com.yfkyplatform.parkinglotmiddleware.carpark.daoer"))
                // 需要生效的uri路径
    ...
    public Docket middlewareApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                // 需要扫描的Controller包路径
                .apis(RequestHandlerSelectors.basePackage("com.yfkyplatform.parkinglotmiddleware.api.web"))
                // 需要生效的uri路径
                .paths(PathSelectors.any())
                .build();
    }
