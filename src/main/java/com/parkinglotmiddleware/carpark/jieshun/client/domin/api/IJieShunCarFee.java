...
import com.parkinglotmiddleware.carpark.jieshun.client.domin.resp.carfee.CarFeeResult;
import com.parkinglotmiddleware.carpark.jieshun.client.domin.resp.carfee.CarFeeResultWithArrear;
 ...
 * @author Suhuyuan
 */
public interface IJieShunCarFee {
    /**
     * 获取临时车缴纳金额
     *
     * @param carNo 车牌号码
